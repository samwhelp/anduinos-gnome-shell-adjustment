...
## ## Link
##
## * https://github.com/samwhelp/anduinos-gnome-shell-adjustment/blob/main/project/gnome-shell-layout/gnome-shell-layout-advance/installer/gnome-extensions-cli/install.sh#L30
##
