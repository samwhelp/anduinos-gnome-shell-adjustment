...
# AnduinOS Gnome Shell Keybindings
...
| `Alt + Shift + f` | Launch File Manager (nautilus) |
| `Alt + Shift + g` | Launch File Manager (thunar) |
| `Alt + Shift + e` | Launch Text Editor (gnome-text-editor) |
| `Alt + Shift + b` | Launch Web Browser (firefox) |
| `Alt + Shift + s` | Launch System Settings (gnome-control-center) |
| `Alt + Ctrl + s` | Launch System Settings (gnome-control-center) |
| `Win + Shift + s` | Launch System Settings (gnome-control-center) |
| `Win + Ctrl + s` | Launch System Settings (gnome-control-center) |
| `Ctrl + Esc` | Launch Task Manager (gnome-system-monitor) |
| `Win + p` | Launch Display Settings () |
| `Alt + Enter` | Launch Terminal (kgx) |
| `Alt + Shift + a` | Launch Terminal (kgx) |
| `Alt + Ctrl + a` | Launch Terminal (gnome-terminal) |
| `Alt + Shift + t` | Launch Terminal (xfce4-terminal) |
| `Alt + Ctrl + t` | Launch Terminal (qterminal) |
| `Win + q` | Window Close |
