...
| `Alt + Shift + e` | 開啟 (gnome-text-editor) |
| `Alt + Shift + b` | 開啟網頁瀏覽器 (firefox) |
| `Alt + Shift + s` | 開啟系統設定 (gnome-control-center) |
| `Alt + Ctrl + s` | 開啟系統設定 (gnome-control-center) |
| `Win + Shift + s` | 開啟系統設定 (gnome-control-center) |
| `Win + Ctrl + s` | 開啟系統設定 (gnome-control-center) |
