...
--center \
--title="AnduinOS Gnome Shell 按鍵綁定" \
--no-buttons \
--list \
--column=按鍵綁定: \
--column=執行動作: \
...
"Alt + Shift + f" "開啟檔案管理器 (nautilus)" "#ffffff" "Monospace 16" \
"Alt + Shift + g" "開啟檔案管理器 (thunar)" "#cccccc" "Monospace 16" \
"Alt + Shift + e" "開啟 (gnome-text-editor)" "#ffffff" "Monospace 16" \
"Alt + Shift + b" "開啟網頁瀏覽器 (firefox)" "#cccccc" "Monospace 16" \
"Alt + Shift + s" "開啟系統設定 (gnome-control-center)" "#ffffff" "Monospace 16" \
"Alt + Ctrl + s" "開啟系統設定 (gnome-control-center)" "#cccccc" "Monospace 16" \
"Win + Shift + s" "開啟系統設定 (gnome-control-center)" "#ffffff" "Monospace 16" \
"Win + Ctrl + s" "開啟系統設定 (gnome-control-center)" "#cccccc" "Monospace 16" \
"Ctrl + Esc" "開啟程序管理器 (gnome-system-monitor)" "#ffffff" "Monospace 16" \
"Win + p" "開啟螢幕解析度設定 ()" "#cccccc" "Monospace 16" \
"Alt + Enter" "開啟 Terminal (kgx)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "開啟 Terminal (kgx)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "開啟 Terminal (gnome-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "開啟 Terminal (xfce4-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + t" "開啟 Terminal (qterminal)" "#ffffff" "Monospace 16" \
