...
/*
	...
	$item['Action'] = "Gnome Shell Reload";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Alt + Ctrl + c";
	$item['Action'] = "Gnome Shell Restart";
	$list[] = $item;
*/
...
*/
	...
	$item['Action'] = "Launch File Manager (nautilus)";
	$list[] = $item;
	...
	$item['Action'] = "Launch Text Editor (gnome-text-editor)";
	$list[] = $item;
	...
	$item['Action'] = "Launch System Settings (gnome-control-center)";
	$list[] = $item;
	...
	$item['Action'] = "Launch Task Manager (gnome-system-monitor)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Win + p";
	$item['Action'] = "Launch Display Settings ()";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Alt + Enter";
	$item['Action'] = "Launch Terminal (kgx)";
	$list[] = $item;
	...
	$item['Action'] = "Launch Terminal (gnome-terminal)";
	$list[] = $item;
